...
public class TestAspect {
	...
	@Pointcut("execution(* com.heqing.ssm.base.*.*(..))")
    public void baseServiceImpl(){}
	
	@Pointcut("execution(* com.heqing.ssm.service.impl.*.*(..))")
    public void serviceImpl(){}
	
	@Pointcut("execution(* com.heqing.ssm.dao.impl.*.*(..))")
    public void daoImpl(){}
     ...
     * @throws Throwable 
     */ 
	@Around("baseServiceImpl() || serviceImpl()")  
